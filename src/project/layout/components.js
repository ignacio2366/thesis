...
const Writer = () => {
    ...
    const handleChange = (event) => {
        const headline = event.target.headline
                ...
                <Main>
                    <Grammarly clientId="client_C16r1uyjZx5bxd956cMhxU">
                        <GrammarlyEditorPlugin>
                            <Headline spellCheck="true" placeholder="Headline" name="headline" required />
                        </GrammarlyEditorPlugin>
                        <CategorySelect id="category" name="category">
                            ...
                            {category.map((category, index) => {
                                return (
                                    <>
                                        <CategotyOption value={category.name} onChange={handleChange}>{category.name}</CategotyOption></>
                                )
                            })}
                        </CategorySelect>
                        <GrayLine />
